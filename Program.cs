...
");
    ...
    string rolanimacion1 = rolesregist[rol1];
    string rolanimacion2 = rolesregist[rol2];
    ...
    for (int i = 0; i < 22; i++)
    {
        ...
        int y = random.Next(rolesregist.Length);
        int p = random.Next(rolesregist.Length);
        Console.ResetColor();
        Console.Clear();
        Console.ForegroundColor = ConsoleColor.Yellow;
        System.Console.WriteLine(ConvertirATextoAscii2(rolesregist[y]));
...
░░░░░                                                                  ░░░░░                                  ");
           ...
           {
            Thread.Sleep(800);
            File.WriteAllText(@"C:\Users\micha\OneDrive\Escritorio\Codigos\Competencia\Datos\roles.txt", string.Empty); 
